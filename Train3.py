...
while 1:
    ...
    for i in range(len(arraydata)):
        ...
        temp = min(tempK1, tempK2, tempK3, tempK4, tempK5, tempK6, tempK7)
    ...
    if (k1 == Clusterbaru1 and k2 == Clusterbaru2 and k3 == Clusterbaru3 and k4 == Clusterbaru4 and
                k5 == Clusterbaru5 and k6 == Clusterbaru6 and k7 == Clusterbaru7):
        break
...
plt.legend((cluster_1,cluster_2,cluster_3,cluster_4,cluster_5,cluster_6,cluster_7),
